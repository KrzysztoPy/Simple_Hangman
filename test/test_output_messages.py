...
def test_messages_for_player(message, expected):
    result = om.messages_for_player(message)
...
def test_messages_for_programmer(message, expected):
    result = om.messages_for_programmer(message)
...
def test_menu_text(message, expected):
    result = om.menu_text(message)
